        ...
        {priests.map((priest) => (
          <div key={priest.id} className="card overflow-hidden">
            <div className="flex flex-col md:flex-row">
              {/* Left — Profile */}
              <div className="flex flex-col items-center bg-gradient-to-b from-temple-cream to-white p-5 sm:p-8 md:w-64 lg:w-72">
                ...
                <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                  {Object.entries(priest.stats).map(([key, val]) => (
                    <div key={key}>
                      <p className="text-sm sm:text-lg font-bold text-temple-maroon">{val}</p>
