...
describe("AdminLayout", () => {
  ...
  it("renders children as a pass-through", () => {
    render(
      <AdminLayout>
  ...
  it("does not add any wrapper elements beyond fragment", () => {
    const { container } = render(
      <AdminLayout>
        <p>Content</p>
      </AdminLayout>
    );
    // The layout is just a fragment, so the <p> should be a direct child of the container
